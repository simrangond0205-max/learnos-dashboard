...
export function CourseCard({ course }: CourseCardProps) {
  ...
  return (
    <Link href={`/courses/${course.id}`} className="block h-full">
      <motion.article
        className="relative overflow-hidden rounded-3xl border border-card-border bg-card p-6 flex flex-col justify-between group h-full min-h-[200px] cursor-pointer"
